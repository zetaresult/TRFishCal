...
if menu == "경험치 및 낚시 계산기":
    ...
    st.markdown(f"<div style='font-size: 20px; font-weight: bold; margin-top: 12px;'>{selected_name}은(는) 약 {round(rod_seconds//((min_default2+max_default2)/2)):,}개 소모됩니다.</div>", unsafe_allow_html=True)
