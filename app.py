...
def scheduleInfo():
    ...
    # st.markdown("2. 입력 창에 명령어를 붙여넣고 Enter 키를 누르세요.")
    # st.markdown("[info]")
    # st.markdown("평균적인 시간이므로 최대 살림망까지 다 차지 않을 수 있습니다.")
    # st.markdown("반드시 낚싯대와 낚시 프렌즈 선택 후 예약 종료 명령어를 입력 바랍니다. (명령어 끝이 0일 경우, 컴퓨터가 로 강제 종료됨)")
    st.markdown("""
